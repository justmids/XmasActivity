...
h_jQuery(document).ready(function () {    
   h_jQuery("a[href^=http]:not([href*='facebook.com'],[href*='plurk.com'],[href*='twitter.com'],[href*='youtube.com'],[href*='google.com'],[href*='ireader.cc'])").live('click', function () {
        var re1 = /books.com.tw/;
        var re2 = /(books.com.tw|facebook.com|plurk.com|twitter.com|youtube.com|google.com)/;
        var re3 = /(myaccount.books.com.tw|activity.books.com.tw)/;
        var a = this.href;
        if (re1.test(a)) {
